...
# Concrete Observer: Teacher Notifier
class TeacherNotifier(Observer):
    def update(self, student_name, grade):
        print(f"[Teacher Notifier] Notification: {student_name} received {grade}. Please review if necessary.")
